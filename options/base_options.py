...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="test_name", help='Name of this trial')
        ...
        self.parser.add_argument('--dataset_name', type=str, default='BABEL_TEACH', help='Dataset Name')
