...
class st2m_TrainCompOptions(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)
        self.parser.add_argument('--batch_size', type=int, default=32, help='Batch size')
        ...
        self.parser.add_argument('--lambda_kld', type=float, default=0.01, help='Weight factor for KL Divergence')
        ...
        self.parser.add_argument('--val_same_num', type=int, default=32, help='val_same_num in training')
        self.parser.add_argument('--val_diff_num', type=int, default=5, help='val_diff_num in training')

        self.is_train = True


class st2m_Train_withpast_Options(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)
        self.parser.add_argument('--batch_size', type=int, default=32, help='Batch size')
        ...
        self.parser.add_argument('--lambda_rec_mot', type=float, default=1, help='Weight factor for motion reconstruction')
        self.parser.add_argument('--lambda_kld', type=float, default=0.01, help='Weight factor for KL Divergence')
        self.parser.add_argument('--lambda_transition', type=float, default=0.1, help='Weight factor for transition loss')

        self.parser.add_argument('--lr', type=float, default=2e-4, help='Learning rate')

        self.parser.add_argument('--is_continue', action="store_true", help='Is this trail continued from previous trail?')

        self.parser.add_argument('--log_every', type=int, default=25, help='Frequency of printing training progress (by iteration)')
        self.parser.add_argument('--save_every_e', type=int, default=10, help='Frequency of saving models (by epoch)')
        self.parser.add_argument('--eval_every_e', type=int, default=10, help='Frequency of animation results (by epoch)')
        self.parser.add_argument('--save_latest', type=int, default=500, help='Frequency of saving models (by iteration)')


        self.parser.add_argument('--max_epoch', type=int, default=500, help='Maximum epoch while training')
        self.parser.add_argument('--val_same_num', type=int, default=32, help='val_same_num in training')
        self.parser.add_argument('--val_diff_num', type=int, default=5, help='val_diff_num in training')
...
class st2m_TrainDecompOptions():
    def __init__(self):
        self.parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
        self.parser.add_argument('--name', type=str, default="zss_Decomp_SP0001SM0001H512_MTM-single", help='Name of this trial')
        self.parser.add_argument("--gpu_id", type=int, default=0,
                                 help='GPU id')

        self.parser.add_argument('--dataset_name', type=str, default='MTM_single', help='Dataset Name')
...
class st2m_TrainTexMotMatchOptions():
    def __init__(self):
        self.parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
        self.parser.add_argument('--name', type=str, default="text_mot_match_M10_STDM", help='Name of this trial')
        ...
        self.parser.add_argument('--save_latest', type=int, default=500, help='Frequency of printing training progress')
        # stdm
        self.parser.add_argument('--mul_data_size', type=int, default=2, help='one mul data size')
